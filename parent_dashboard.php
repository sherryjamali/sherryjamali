...
<div id="parent_dashboard">
 ...
 <?php include 'parent_dashboard_ajax.php';?>
</div>
...
<script type="text/javascript">
 jQuery(document).ready(function($) {
      ...
      if (window.history && window.history.pushState) {
        ...
        window.history.pushState('<?php echo base_url();?>index.php?parents/dashboard', null, null);
      }
...
function attendance()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_attendance',
...
function dues()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_dues',
...
function marks()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_marks',
...
function study_material()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_study_material',
...
function academic_syllabus()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_academic_syllabus',
...
function noticeboard()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_noticeboard',
...
function msg()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_msg',
                 ...
                 success: function(response)
            {
                 jQuery('div.loading').fadeOut(1000);
                  jQuery('#result').html(response);
                 $('#parent_dashboard').hide();
                 $(document).attr("title", "Contact School | <?php echo $system_name;?>");
                 NProgress.done();
    ...
    function apply_leave()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_leave',
       ...
       function transport()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_transport',
       ...
       function diary()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_diary',
           ...
           function profile()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_profile',
                 ...
                 success: function(response)
            {
                 jQuery('div.loading').fadeOut(1000);
                  jQuery('#result').html(response);
                 $('#parent_dashboard').hide();
                 $(document).attr("title", "Manage Profile | <?php echo $system_name;?>");
                 NProgress.done();
           ...
           function leave_status()
    {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url();?>index.php?parents/ajax_leave_status',
